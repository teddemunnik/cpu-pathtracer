...
void Surface::SaveImage( char* a_File){
	FIBITMAP* bitmap = FreeImage_ConvertFromRawBits((BYTE*)m_Buffer, m_Width, m_Height, m_Width*sizeof(unsigned int), 32, REDMASK, GREENMASK, BLUEMASK, true);
	bitmap = FreeImage_ConvertTo24Bits(bitmap);
	FreeImage_Save(FIF_JPEG, bitmap, a_File);
